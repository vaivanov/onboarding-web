...
const withPlaygroundProgress = graphql(GET_SMOKEFREE_PROGRESS, {
    props: ({ownProps, data}) => {
        ...
        console.log("withPlaygroundProgress " ,data.progress);
        return {
        ...
        return (
            <div className={classes.section + " playground-statistics wrapper"}>
                ...
                <div className={classes.container + " playground-statistics container"}>
                    ...
                    <div>
                        <GridContainer mode={this.props.mode}>
                            <GridItem xs={12} sm={12} md={8} lg={6} className="grid-item" mode={this.props.mode}>
